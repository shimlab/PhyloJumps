...
treeHPYP: categorical.py

Created on 2021-07-29 10:00

Implements a simple categorical distribution based on a Python dictionary object.
@author: Hanxi Sun
...
class Categorical(dict):
    ...
    def __init__(self, labels=None, probs=None, K: int = 2, normalize=True):
        super().__init__()
