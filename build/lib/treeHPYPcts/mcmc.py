...
class TreeMCMC:
    ...
    def load_samples(self, path):
        ...
        n_chains = param_trace.shape[0]
        jps = [0] * n_chains
        partitions = [0] * n_chains
        ...
        samples = param_trace.to_dict()
        samples['partitions'] = partitions
        samples['jumps'] = jps
        return samples
    ...
    def load_metadata(self, path):
        ...
        try:
            ...
            self.seeds = metadata['seeds'] if metadata['seeds'] != '' else self.seeds
